...
const mapDispatchToProps = dispatch => {
  return {
    getExpenses: () => dispatch({ type: 'masterData/GET_EXPENSES' }),
    resetExpenses: () =>
      dispatch({
...
class TableExpense extends React.Component {
  ...
  componentDidMount() {
    const { getExpenses, resetExpenses } = this.props
    resetExpenses()
    getExpenses()
  }
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        width: 200,
        sorter: (a, b) => a.measurement_unit_name.length - b.measurement_unit_name.length,
        sortOrder: sortedInfo.columnKey === 'measurement_unit_name' && sortedInfo.order,
      },
      {
        title: 'Deskripsi',
