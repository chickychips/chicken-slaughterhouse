...
const mapDispatchToProps = dispatch => {
  return {
    getSuppliers: () => dispatch({ type: 'masterData/GET_SUPPLIERS' }),
    resetSuppliers: () =>
      dispatch({
...
class TableSupplier extends React.Component {
  ...
  componentDidMount() {
    const { getSuppliers, resetSuppliers } = this.props
    resetSuppliers()
    getSuppliers()
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(TableSupplier)
